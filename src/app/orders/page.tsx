...
export default function OrdersPage() {
  ...
  return (
    <div className="flex flex-col h-[calc(100vh-4rem)] overflow-hidden">
      ...
      {/* Search */}
      <div className="flex-shrink-0 card !py-4 mt-4">
      ...
      <div className="flex-1 flex flex-col min-h-0 mt-4">
        {loading ? (
          ...
          <>
            <div className="flex-1 overflow-auto border border-gray-200 rounded-t-xl">
              <table className="w-full text-sm border-collapse">
                <thead className="sticky top-0 z-10">
                  <tr className="bg-gray-50">
                    {['外部编码', '收货门店', '收件人', '电话', '地址', 'SKU编码', 'SKU名称', '数量', '规格', '备注', '提交时间'].map(h => (
                      <th key={h} className="px-3 py-2.5 text-left text-xs font-semibold text-gray-500 whitespace-nowrap border-b bg-gray-50">
                        {h}
                      </th>
                    ))}
                  </tr>
            ...
            <div className="flex items-center justify-between mt-2 flex-shrink-0">
              ...
              <div className="flex items-center gap-2">
                ...
                {/* Page buttons - only show when totalPages > 1 */}
                {totalPages > 1 && (
